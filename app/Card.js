...
export default function Card ({item, index, view}) {
    ...
    return(
        <div className='relative'>
            <section style={{background: objectStyle[index].color}} className={`flex justify-end rounded-t-xl `}>
                <Image src={objectStyle[index].img} alt='#' height={80} />
            </section>
            <section className='grid z-20 gap-4 bg-darkBlue hover:bg-desaturatedBlue -mt-6 p-7 rounded-xl h-46 cursor-pointer relative lg:absolute w-full lg:w-64'>
